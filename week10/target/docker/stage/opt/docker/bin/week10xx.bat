@REM week10xx launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM WEEK10XX_config.txt found in the WEEK10XX_HOME.
...
if "%WEEK10XX_HOME%"=="" (
  ...
  set "WEEK10XX_HOME=%~dp0\\.."
) else (
  set "APP_HOME=%WEEK10XX_HOME%"
)
...
set "CFG_FILE=%APP_HOME%\WEEK10XX_config.txt"
set CFG_OPTS=
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running week10xx.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !WEEK10XX_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
